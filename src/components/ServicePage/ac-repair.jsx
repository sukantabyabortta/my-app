...
const ACRepair = () => {
      const { servicesAC, serviceAbout, popularServicesAC, guaranteeData, bookService } = ServiceData;
      return (
            <>
            <div className="hero">
                  <div className="container">
                        {servicesAC.map((item, index) => (
                              <div key={index}>
                                    <div>
                                          <h1>{item.title}</h1>
                  ...
                  <div className="container">
                        {serviceAbout.map((section, index) => (
                              <div key={index}>
                                    ...
                                    {section.descriptionAC.map((desc, i) => (
                                          <p key={i}>
                                          {desc.before}
