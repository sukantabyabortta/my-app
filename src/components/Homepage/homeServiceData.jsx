    ...
    <>
            ...
            <ul>
              {HomeServiceData.homeServiceContent.map((item, index) => (
                <li key={index}>
                  ...
                  <p>{item.desc}</p>
                  <Link to={item.url} className="readMore">
                    Read more +
                  </Link>
                </li>
              ))}
      ...
      <section className="WhyChooseUs">
        <div className="container">
          ...
          <p>
            <SecPara
              para="With over 10 years of experience in appliance repair, we offer reliable, affordable, and professional services. Our certified technicians use genuine parts, provide same-day service, and guarantee customer satisfaction. We are your trusted local repair
                  experts in SR."
            />
          </p>
          ...
          <div className="whoWeAreCont">
            ...
            <div>
              ...
              <p>{HomeServiceData.whoWeAreCont.para}</p>
              <ul>
      ...
      <section className="lookingForService">
        <div className="container">
          <div>
            <img
              src={HomeServiceData.lookingForService.image1}
              alt="Service inquiry icon"
            />
            <div>
          ...
          <div>
            <img
              src={HomeServiceData.lookingForService.image2}
